...
\cventry{02/2016--}{Full stack developer}{\textsc{Analyse²}}{}{}{\analysecontent}
...
\cvdoubleitem[.3cm]{\langscript}
             {Java, C\#, JavaScript,\\ TypeScript, HTML, CSS, SQL, Bash, Fortran, \\MATLAB, Clojure, \LaTeX}
             {\techframe}
             {Spring, JUnit, Mockito, JRebel, Struts2, .NET, Moq, AngularJS, jQuery, JSP, Robot Framework, JBoss, Tomcat, AWS, git, SVN}
\cvdoubleitem[.3cm]{OS}
             {Linux, Windows}
             {\db}
             {MySQL, PostgreSQL}
