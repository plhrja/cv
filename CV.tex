...
\cvdoubleitem[.3cm]{\langscript}
             {C\#, TypeScript/JS, Bash, Python, SQL, HTML, CSS/LESS, \LaTeX}
             {\techframe}
             {Cloudformation, CDK, Terraform, Docker, K8s, Helm, RF, .NET, Angular, git}
\cvdoubleitem[.3cm]{OS/Platform}
             {AWS, Azure, Linux, Windows, Snowflake}
             {\db}
