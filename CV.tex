...
\cvdoubleitem[.3cm]{\langscript}
             {Java, C\#, JavaScript, TypeScript, HTML, CSS, LESS, SQL, Bash, MATLAB, \LaTeX}
             {\techframe}
             {.NET Core, Nunit, Moq, Spring, JUnit, Mockito, Angular, mobx, webpack, Rake, ag-grid, Protractor, Cucumber, Robot Framework, AWS, git}
\cvdoubleitem[.3cm]{OS}
             {Linux, Windows}
             {\db}
