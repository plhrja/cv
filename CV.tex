...
\cvdoubleitem[.3cm]{\langscript}
             {Java, C\#, JavaScript, TypeScript, HTML, CSS, SQL, Bash, MATLAB, \LaTeX}
             {\techframe}
             {Spring, JUnit, Mockito, .NET, Moq, AngularJS, mobx, gulp, webpack, ag-grid, Protractor, Cucumber, Robot Framework, AWS, git, SVN}
\cvdoubleitem[.3cm]{OS}
             {Linux, Windows}
             {\db}
