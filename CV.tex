...
\cvdoubleitem[.3cm]{\langscript}
             ...
             {\techframe}
             {Spring, JUnit, Mockito, JRebel, .NET, Moq, AngularJS, jQuery, gulp, webpack, Robot Framework, JBoss, Tomcat, AWS, git, SVN}
\cvdoubleitem[.3cm]{OS}
             {Linux, Windows}
             {\db}
             {MySQL, PostgreSQL}
...
%\section{Länkar}
\cventry{}{}{}{
 \href{http://plhrja.github.io/Pro-gradu_Robert_Sirviö.pdf}{{\color{blue}\mthesis}}}{}{}
